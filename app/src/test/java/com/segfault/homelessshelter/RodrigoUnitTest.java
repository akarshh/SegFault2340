...
public class RodrigoUnitTest {
    ...
    private String[] entries = {
            ...
            "7,Covenant House Georgia ,80,Children/Young adults ,-84.437988,33.78823,\"1559 Johnson Road NW, Atlanta, GA 30318\",Crisis services/Career Preparation,(404)-937-6957",
    ...
    private Shelter[] expected = {
            ...
            new Shelter(2, "The Shepherd's Inn", "450", "Men", -84.39265, 33.765162, "156 Mills Street, Atlanta, Georgia 30313", "Temporary, Residential Recovery", "(404) 367-2493"),
            ...
            new Shelter(5, "Eden Village ", "32 for families, 80 singles", "Women/Children", -84.43023, 33.762316, "1300 Joseph E. Boone Blvd NW, Atlanta, GA 30314", "General recovery services", "(404)-874-2241"),
            new Shelter(6, "Our House ", "76 family rooms ", "Families w/ Newborns ", -84.371706, 33.759138, "173 Boulevard Northeast, Atlanta, GA 30312", "Families w/ Newborns, Pre-K education", "(404) 522-6056"),
            new Shelter(7, "Covenant House Georgia ", "80", "Children/Young adults ", -84.437988, 33.78823, "1559 Johnson Road NW, Atlanta, GA 30318", "Crisis services/Career Preparation", "(404)-937-6957"),
            new Shelter(8, "Nicholas House", "", "Families ", -84.367953, 33.731823, "830 Boulevard SE, Atlanta, GA 30312", "Family services ", "(404)-622-0793"),
            new Shelter(9, "Hope Atlanta ", "22 apartments", "Anyone ", -84.390429, 33.753594, "34 Peachtree Street NW, Suite 700, Atlanta, GA 30303", "Emergency shelter ", "(404)-817-7070"),
            new Shelter(10, "Gateway Center", "330", "Men", -84.394529, 33.747618, "275 Pryor St. SW, Atlanta, GA 30303", "Shelter and recovery services ", "(404) 215-6600"),
            new Shelter(11, "Young Adult Guidance Center ", "12", "Young adults ", -84.470567, 33.789157, "1230 Hightower Road NW Atlanta, GA 30318", "Emergency, Independent living, Restoration ", "(404) 792-7616"),
            new Shelter(12, "Homes of Light ", "", "Veterans ", -84.328691, 33.747641, "1800 Memorial Dr SE G3, Atlanta, GA 30317", "Veterans ", "(844) 289-8382")
    };

    // This is what we will be comparing against
    private Shelter[] actual = new Shelter[13];

    @Test
    public void testShelterCreationFromCSVEntry() {
        for(int i = 0; i < actual.length; i++) {
            actual[i] = Shelter.createFromCSVEntry(entries[i]);
        }
